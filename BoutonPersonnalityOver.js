function BoutonPersonnalityOver(){
    ...
    // diagrammes en fleurs
        ...
        const SignPersonnalite = d3.group(donnees, d => d.signe, d => d.personnalite)
        ...
        if (QuelMoisSommesNous == 1) {
            ...
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Sagittarius")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            
            etoile_jaune.transition()
                .duration(1000) 
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+90 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+190 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+90 + 80)*addaptation)+addaptationX)
                .attr('y', ((milieuY+190 + 60)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
                .transition() 
                .duration(1000)
                .attr('opacity', "0.5") 
            ...
            etoile_bleu.transition()
                .duration(1000) 
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX+60 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-190 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', ((milieuX+60 + 80)*addaptation)+addaptationX)
                .attr('y', ((milieuY-190 + 50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
                .transition() 
                .duration(1000)
                .attr('opacity', "0.5")     
            ...
            etoile_rose.transition()
                .duration(1000) 
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX-300 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-310 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX-300 + 70)*addaptation)+addaptationX)
                .attr('y', ((milieuY-310 + 50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
                .transition() 
                .duration(1000)
                .attr('opacity', "0.5")  
            ...
            etoile_vert.transition()
                .duration(1000) 
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('x', ((milieuX-260 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )*addaptation)+addaptationX)
                .attr('y', ((milieuY+20 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', ((milieuX-260 + 60)*addaptation)+addaptationX)
                .attr('y', ((milieuY+20 + 50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
                .transition() 
                .duration(1000)
                .attr('opacity', "0.5")  
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Capricornus")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            
            etoile_jaune.transition()
                .duration(1000) 
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+90-90 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY+190 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX-90+90 + 80)*addaptation)+addaptationX+ add10)
                .attr('y', ((milieuY+190 + 60)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX-40-90 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY-190 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', ((milieuX-40-90 + 70)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY-190 + 50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
            ...
            etoile_rose.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX-440-90 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY-230 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX-440-90 + 50)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY-230 + 50 -50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('x', ((milieuX-270-90 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY-10 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', ((milieuX-270-90 + 50)*addaptation)+addaptationX+add10)
                .attr('y', ((milieuY-10 + 50 -50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
                const SignPersonnalitePersonnalite = SignPersonnalite.get("Aquarius")
                let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
                let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
                let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
                ...
                etoile_jaune.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                    .attr('x', ((milieuX+180 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY+40 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

                let SpecieTexteJaune = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteJaune")
                    .attr('x', ((milieuX+180 + 80)*addaptation)+addaptationX)
                    .attr('y', ((milieuY+40 + 60)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                    .attr('opacity', "0") 
                ...
                etoile_bleu.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                    .attr('x', ((milieuX+150 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX )
                    .attr('y', ((milieuY-150 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                    
                let SpecieTexteBleu = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteBleu")
                    .attr('x', ((milieuX+150 + 70)*addaptation)+addaptationX)
                ...
                etoile_rose.transition()
                    ...
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                    .attr('x', ((milieuX-300 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-90-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

                let SpecieTexteRose = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteRose")
                    .attr('x', ((milieuX-300 + 50)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-90 + 50 -60)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                    .attr('opacity', "0") 
                ...
                etoile_vert.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                    .attr('x', ((milieuX-130 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-300 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

                let SpecieTexteVert = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteVert")
                    .attr('x', ((milieuX-130 + 50)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-300 + 50 -60)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                    .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Pisces")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 110-70 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+230 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 110-70 + 80)*addaptation)+addaptationX)
                .attr('y',(( milieuY+230 + 60)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 290-70 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-140 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
            ...
            etoile_rose.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 30-70 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )*addaptation)+addaptationX)
                .attr('y', ((milieuY-180-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX+ 30-70)*addaptation)+addaptationX)
                .attr('y', ((milieuY-180 + 50 -100)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height',( 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('width',( 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('x', ((milieuX- 270-70 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY- 270 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', ((milieuX- 270-70 + 50)*addaptation)+addaptationX)
                .attr('y', ((milieuY- 270 + 50 -60)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Aries")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 130-150 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY- 220 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 130-150 + 80)*addaptation)+addaptationX)
                .attr('y', ((milieuY- 220 + 60)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 300-150 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX )
                .attr('y', ((milieuY- 250 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', ((milieuX+ 300-150)*addaptation)+addaptationX)
                .attr('y', ((milieuY -280)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Taurus")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 65 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+ 85  -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 65 + 60)*addaptation)+addaptationX)
                .attr('y', ((milieuY+ 85 -20)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX-290 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY- 300 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Gemini")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 120 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+65 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 120 + 80)*addaptation)+addaptationX)
                .attr('y', ((milieuY+65+ 60)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 100 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-340 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
            ...
            etoile_rose.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX-245 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )*addaptation)+addaptationX)
                .attr('y', ((milieuY-155-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX-245-70)*addaptation)+addaptationX)
                .attr('y', ((milieuY-155 -20)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('x', ((milieuX- 230 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationX )
                .attr('y', ((milieuY+100 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', ((milieuX- 230 +70)*addaptation)+addaptationX)
                .attr('y', ((milieuY+100 + 50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Cancer")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+ 145 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX )
                .attr('y', ((milieuY+65 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 145 + 80)*addaptation)+addaptationX )
            ...
            etoile_bleu.transition()
                ...
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX-60 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-380 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', ((milieuX-60)*addaptation)+addaptationX)
                .attr('y', ((milieuY-420)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
            ...
            etoile_rose.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX-45 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX )
                .attr('y', ((milieuY-135-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX-45-60)*addaptation)+addaptationX)
                .attr('y', ((milieuY-135 -20)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('x', ((milieuX- 190 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationX )
                .attr('y', ((milieuY+210 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', ((milieuX- 190 +70)*addaptation)+addaptationX)
                .attr('y', ((milieuY +210 + 50)*addaptation)+addaptationY )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
                const SignPersonnalitePersonnalite = SignPersonnalite.get("Leo")
                let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
                let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
                let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
                ...
                etoile_jaune.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                    .attr('x', ((milieuX+ 228 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY+ 259 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

                let SpecieTexteJaune = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteJaune")
                    .attr('x', ((milieuX+ 228 + 90)*addaptation)+addaptationX)
                    .attr('y', ((milieuY+ 259+ 55)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                    .attr('opacity', "0") 
                ...
                etoile_bleu.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                    .attr('x', ((milieuX-295 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX )
                    .attr('y', ((milieuY-345 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                    
                let SpecieTexteBleu = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteBleu")
                    .attr('x', ((milieuX-295)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-385)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                    .attr('opacity', "0") 
                ...
                etoile_rose.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                    .attr('x', ((milieuX-140 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX )
                    .attr('y', ((milieuY-145-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

                let SpecieTexteRose = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteRose")
                    .attr('x', ((milieuX-140-60)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-145 -20)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                    .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
                const SignPersonnalitePersonnalite = SignPersonnalite.get("Virgo")
                let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
                let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
                let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
                ...
                etoile_jaune.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                    .attr('x', ((milieuX+ 42 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY+ 20 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

                let SpecieTexteJaune = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteJaune")
                    .attr('x', ((milieuX+ 42 + 60)*addaptation)+addaptationX)
                ...
                etoile_bleu.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                    .attr('x', ((milieuX+115 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-270 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                ...
                etoile_rose.transition()
                    ...
                    .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                    .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                    .attr('x', ((milieuX-177 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-175-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

                let SpecieTexteRose = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteRose")
                    .attr('x', ((milieuX-177)*addaptation)+addaptationX)
                    .attr('y', ((milieuY-175 -30)*addaptation)+addaptationY)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                    .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Libra")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+32 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-85 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 32 + 80)*addaptation)+addaptationX)
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX+166 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+40 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', ((milieuX+166 +50)*addaptation)+addaptationX)
                .attr('y', ((milieuY+40 -10)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
            ...
            etoile_rose.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX-152 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX )
                .attr('y', ((milieuY-225-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX-152-60)*addaptation)+addaptationX)
                .attr('y', ((milieuY-225 -20)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)*addaptation)
                .attr('x', ((milieuX- 117 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+148 -SignPersonnaliteArrayOrdrePlus[3][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', ((milieuX- 117 +70)*addaptation)+addaptationX)
                .attr('y', ((milieuY +148 + 50)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
            const SignPersonnalitePersonnalite = SignPersonnalite.get("Scorpio")
            let SignPersonnaliteArray = Array.from(SignPersonnalitePersonnalite)
            let SignPersonnaliteArrayOrdreMoins = d3.sort(SignPersonnaliteArray, (d) => d[1].length)
            let SignPersonnaliteArrayOrdrePlus=  d3.reverse(SignPersonnaliteArrayOrdreMoins)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)*addaptation)
                .attr('x', ((milieuX+32 -200 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-105 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)*addaptation)+addaptationY)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', ((milieuX+ 32 -200 + 90)*addaptation)+addaptationX)
            ...
            etoile_bleu.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)*addaptation)
                .attr('x', ((milieuX+106 -200 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY+60 -SignPersonnaliteArrayOrdrePlus[1][1].length*5)*addaptation)+addaptationY) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', (( milieuX+106 -200 +50)*addaptation)+addaptationX)
                .attr('y', ((milieuY+60 -10)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
            ...
            etoile_rose.transition()
                ...
                .attr('height', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('width', (50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)*addaptation)
                .attr('x', ((milieuX-152 -200 -SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationX)
                .attr('y', ((milieuY-245-SignPersonnaliteArrayOrdrePlus[2][1].length*5)*addaptation)+addaptationY) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', ((milieuX-152 -200-60)*addaptation)+addaptationX)
                .attr('y', ((milieuY-245 -10)*addaptation)+addaptationY)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
        ...
        //Snooty
            ...
            //Fleur Big sister
                ...
                .attr('x', ((PositionX1-50)*addaptation))
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${((PositionX1)*addaptation)},${PositionY1})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity", 0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${((PositionX1)*addaptation)},${PositionY1}) translate(${arcGeneratorlabel.centroid(d)})`)
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${((PositionX1)*addaptation)},${PositionY1+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                for (let i = 0; i < SigngenderHobbyBigSisterArray.length; i++) {
                    MonEspaceSVG.append('line')
                        ...
                        .attr('x1', ((PositionX1 -60 + i*28)*addaptation))
                        .attr('y1', PositionY1 +3)
                        .attr('x2', ((PositionX1 -60 + i*28)*addaptation))
                    ...
                    for (let a = 0; a < Personnalite.length; a++) {
                        if (SigngenderHobbyBigSisterArray[i][0] == Personnalite[a][0]) {
                            d3.select(`#TraitBigSister${i}`)
                                .attr('x1', ((PositionX1 -60 + a*28)*addaptation))
                                .attr('x2', ((PositionX1 -60 + a*28)*addaptation))
            ...
            //Fleur Normal
                MonEspaceSVG.append('text')
                    .text("Normal") 
                    .attr("id", `TitreNormal`)
                    .attr('x', ((PositionX2-40)*addaptation))
                    .attr('y', PositionY1-130)
                    .attr('fill', "white")
                    .attr('opacity', "0")
                    .attr('font-size', "25")
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${((PositionX2)*addaptation)},${PositionY1})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity", 0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${((PositionX2)*addaptation)},${PositionY1}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${((PositionX2)*addaptation)},${PositionY1+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                for (let i = 0; i < SigngenderHobbyNormalArray.length; i++) {
                    MonEspaceSVG.append('line')
                        ...
                        .attr('x1', ((PositionX2 -60 + i*28)*addaptation))
                        .attr('y1', PositionY1 +3 )
                        .attr('x2', ((PositionX2 -60 + i*28)*addaptation))
                        ...
                        for (let a = 0; a < Personnalite.length; a++) {
                            if (SigngenderHobbyNormalArray[i][0] == Personnalite[a][0]) {
                                d3.select(`#TraitNormal${i}`)
                                    .attr('x1', ((PositionX2 -60 + a*28)*addaptation))
                                    .attr('x2', ((PositionX2 -60 + a*28)*addaptation))
                                    .attr("stroke", `${Personnalite[a][1]}`)
                                    .transition()
                                        .duration(1050) 
                                        .attr("stroke-opacity", 0.8)
            ...
            //Fleur Cranky
                MonEspaceSVG.append('text')
                    .text("Cranky") 
                    .attr("id", `TitreCranky`)
                    .attr('x', (PositionX1-40)*addaptation)
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${PositionX1*addaptation},${PositionY2})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity", 0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${PositionX1*addaptation},${PositionY2}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${PositionX1*addaptation},${PositionY2+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
            ...
            //Fleur Peppy
                MonEspaceSVG.append('text')
                    .text("Peppy") 
                    .attr("id", `TitrePeppy`)
                    .attr('x', (PositionX2-30)*addaptation)
                    .attr('y', (PositionY2-130))
                    .attr('fill', "white")
                    .attr('opacity', "0")
                    .attr('font-size', "25")
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${PositionX2*addaptation},${PositionY2})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity",0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${PositionX2*addaptation},${PositionY2}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${PositionX2*addaptation},${PositionY2+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
            ...
            //Fleur Jock
                MonEspaceSVG.append('text')
                    .text("Jock") 
                    .attr("id", `TitreJock`)
                    .attr('x', (PositionX1-30)*addaptation)
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${PositionX1*addaptation},${PositionY3})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity",0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${PositionX1*addaptation},${PositionY3}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${PositionX1*addaptation},${PositionY3+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
            ...
            //Fleur Smug
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${PositionX2*addaptation},${PositionY3})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity", 0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${PositionX2*addaptation},${PositionY3}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${PositionX2*addaptation},${PositionY3+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
            ...
            //Fleur Lazy
                ...
                .text("Lazy") 
                .attr("id", `TitreLazy`)
                .attr('x', (PositionX1-25)*addaptation)
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${PositionX1*addaptation},${PositionY4})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity", 0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${PositionX1*addaptation},${PositionY4}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle")
                    .attr('font-family', "AnimalCrossing") 
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${PositionX1*addaptation},${PositionY4+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
            ...
            //Fleur Snooty
                MonEspaceSVG.append('text')
                    .text("Snooty") 
                    .attr("id", `TitreSnooty`)
                    .attr('x', (PositionX2-32)*addaptation)
                    .attr('y', PositionY4-130)
                    .attr('fill', "white")
                    .attr('opacity', "0")
                    .attr('font-size', "25")
                ...
                MonEspaceSVG.selectAll("arc")
                    ...
                    .attr("stroke", "white")
                    .attr("stroke-width", 1)
                    .attr("transform", `translate(${PositionX2*addaptation},${PositionY4})`)
                    .attr("opacity", 0)
                    .transition()
                        .duration(1050) 
                        .attr("opacity", 0.8)
                ...
                MonEspaceSVG.selectAll(".label-espece")
                    ...
                    .text((d) =>  d.data[0]) 
                    .attr("transform", (d) => `translate(${PositionX2*addaptation},${PositionY4}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                MonEspaceSVG.selectAll(".label-Compte")
                    ...
                    .attr("transform", (d) => `translate(${PositionX2*addaptation},${PositionY4+15}) translate(${arcGeneratorlabel.centroid(d)})`)
                    .style("text-anchor", "middle") 
                    .attr('font-family', "AnimalCrossing")
                    .style("fill", "white")
                    .style("font-size", "12px")
                ...
                function ModifieLabels(SigngenderEspeceArray,IdLabels1,IdLabels2,PositionX,PositionY){
                    if (SigngenderEspeceArray.length > 4) {
                        for (let i = 0; i < SigngenderEspeceArray.length; i++) {
                            ...
                            .attr("transform", (d) => `translate(${PositionX*addaptation},${PositionY}) translate(${arcGeneratorlabelMulti.centroid(d)})`)

                            d3.select(`#${IdLabels2}${i}`)
                            .attr("transform", (d) => `translate(${PositionX*addaptation},${PositionY+15}) translate(${arcGeneratorlabelMulti.centroid(d)})`)
                        }
                    }
                }
        ...
        for (let i = 0; i < 3; i++) {
            MonEspaceSVG.append('line')
                ...
                .attr('x1', ((PositionX2 + PositionX1)/2 - 65)*addaptation -less20)
                .attr('y1', PositionY1 -150 + i*20)
                .attr('x2', ((PositionX2 + PositionX1)/2 -65)*addaptation -less20)
            ...
            MonEspaceSVG.append("text")
                ...
                .attr("x", ((PositionX2 + PositionX1)/2 - 59)*addaptation - less20)
        ...
        for (let i = 0; i < 3; i++) {
            ...
            MonEspaceSVG.append("text")
                ...
                .attr("x", ((PositionX2 + PositionX1)/2 +23)*addaptation)
                .attr("y", PositionY1 -150 +8+ i*20)
                .style("text-anchor", "left") 
                .attr('font-family', "AnimalCrossing")
                .style("fill", "white")
 ...
 let FondBlancTexteExpPersonnality = MonEspaceSVG.append("rect")
 .attr("id", "FondBlancTexteExpPersonnality")
 .attr("x", 30)
 .attr("y", 670)
 .attr("width", 710)
 .attr("height", 30)
 ...
 .attr("opacity", 0.5)
  // texte d'explication 
      const texteExpPersonnality = MonEspaceSVG.append('text')
      .text("You can see the personnality of the characters according to their astrological sign.") 
      .attr("id", "texteExpPersonnality")
      .attr('x', 40)
      .attr('y', 690)
      .attr('fill', "black")
      .attr('opacity', "0")
