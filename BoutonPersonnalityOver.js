    ...
    // diagrammes en fleurs
        ...
        if (QuelMoisSommesNous == 1) {
            ...
            etoile_jaune.transition()
                .duration(1000) 
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+90 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY+190 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+90 + 80)
                .attr('y', milieuY+190 + 60 )    
                .attr('fill', "white")
            ...
            etoile_bleu.transition()
                .duration(1000) 
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX+60 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY-190 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', milieuX+60 + 80)
            ...
            etoile_rose.transition()
                .duration(1000) 
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX-300 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-310 -SignPersonnaliteArrayOrdrePlus[2][1].length*5) 
            ...
            etoile_vert.transition()
                .duration(1000) 
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('x', milieuX-260 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                .attr('y', milieuY+20 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', milieuX-260 + 60)
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+90-90 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY+190 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX-90+90 + 80)
                .attr('y', milieuY+190 + 60 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX-40-90 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY-190 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', milieuX-40-90 + 70)
                .attr('y', milieuY-190 + 50 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
            ...
            etoile_rose.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX-440-90 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-230 -SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', milieuX-440-90 + 50)
                .attr('y', milieuY-230 + 50 -50)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('x', milieuX-270-90 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                .attr('y', milieuY-10 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', milieuX-270-90 + 50)
                .attr('y', milieuY-10 + 50 -50)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
                ...
                etoile_jaune.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                    .attr('x', milieuX+180 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                    .attr('y', milieuY+40 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

                let SpecieTexteJaune = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteJaune")
                    .attr('x', milieuX+180 + 80)
                    .attr('y', milieuY+40 + 60 )    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                    .attr('opacity', "0") 
                ...
                etoile_bleu.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                    .attr('x', milieuX+150 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                    .attr('y', milieuY-150 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                ...
                etoile_rose.transition()
                    ...
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                    .attr('x', milieuX-300 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                    .attr('y', milieuY-90-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

                let SpecieTexteRose = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteRose")
                    .attr('x', milieuX-300 + 50)
                    .attr('y', milieuY-90 + 50 -60)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                    .attr('opacity', "0") 
                ...
                etoile_vert.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                    .attr('x', milieuX-130 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                    .attr('y', milieuY-300 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 

                let SpecieTexteVert = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteVert")
                    .attr('x', milieuX-130 + 50)
                    .attr('y', milieuY-300 + 50 -60)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                    .attr('opacity', "0") 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+ 110-70 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY+230 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 110-70 + 80)
                .attr('y', milieuY+230 + 60 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX+ 290-70 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY-140 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
            ...
            etoile_rose.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX+ 30-70 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-180-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', milieuX+ 30-70)
                .attr('y', milieuY-180 + 50 -100)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('x', milieuX- 270-70 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                .attr('y', milieuY- 270 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', milieuX- 270-70 + 50)
                .attr('y', milieuY- 270 + 50 -60)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+ 130-150 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY- 220 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 130-150 + 80)
                .attr('y', milieuY- 220 + 60 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX+ 300-150 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY- 250 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+ 65 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY+ 85  -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 65 + 60)
                .attr('y', milieuY+ 85 -20 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX-290 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY- 300 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+ 120 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY+65 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 120 + 80)
                .attr('y', milieuY+65+ 60 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                .attr('opacity', "0") 
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX+ 100 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY-340 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
            ...
            etoile_rose.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX-245 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-155-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', milieuX-245-70)
                .attr('y', milieuY-155 -20)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('x', milieuX- 230 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                .attr('y', milieuY+100 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+ 145 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY+65 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 145 + 80)
            ...
            etoile_bleu.transition()
                ...
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX-60 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY-380 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
            ...
            etoile_rose.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX-45 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-135-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', milieuX-45-60)
                .attr('y', milieuY-135 -20)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('x', milieuX- 190 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                .attr('y', milieuY+210 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 
            ...
            //déplacement des étoiles 
                ...
                etoile_jaune.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                    .attr('x', milieuX+ 228 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                    .attr('y', milieuY+ 259 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

                let SpecieTexteJaune = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteJaune")
                    .attr('x', milieuX+ 228 + 90)
                    .attr('y', milieuY+ 259+ 55 )    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[0][1].length + " " + SignPersonnaliteArrayOrdrePlus[0][0]  )
                    .attr('opacity', "0") 
                ...
                etoile_bleu.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                    .attr('x', milieuX-295 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                    .attr('y', milieuY-345 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                ...
                etoile_rose.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                    .attr('x', milieuX-140 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                    .attr('y', milieuY-145-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

                let SpecieTexteRose = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteRose")
                    .attr('x', milieuX-140-60)
                    .attr('y', milieuY-145 -20)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                    .attr('opacity', "0") 
            ...
            //déplacement des étoiles 
                ...
                etoile_jaune.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                    .attr('x', milieuX+ 42 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                    .attr('y', milieuY+ 20 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   
                ...
                etoile_bleu.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                    .attr('x', milieuX+115 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                    .attr('y', milieuY-270 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                ...
                etoile_rose.transition()
                    ...
                    .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                    .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                    .attr('x', milieuX-177 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                    .attr('y', milieuY-175-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

                let SpecieTexteRose = MonEspaceSVG.append('text')
                    .attr('id', "SpecieTexteRose")
                    .attr('x', milieuX-177)
                    .attr('y', milieuY-175 -30)    
                    .attr('fill', "white")
                    .attr('font-family', "AnimalCrossing")
                    .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                    .attr('opacity', "0") 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+32 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY-85 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 32 + 80)
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX+166 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY+40 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', milieuX+166 +50)
                .attr('y', milieuY+40 -10 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
            ...
            etoile_rose.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX-152 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-225-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', milieuX-152-60)
                .attr('y', milieuY-225 -20)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
            ...
            etoile_vert.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[3][1].length*10)
                .attr('x', milieuX- 117 -SignPersonnaliteArrayOrdrePlus[3][1].length*5 )
                .attr('y', milieuY+148 -SignPersonnaliteArrayOrdrePlus[3][1].length*5) 

            let SpecieTexteVert = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteVert")
                .attr('x', milieuX- 117 +70)
                .attr('y', milieuY +148 + 50 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[3][1].length + " " + SignPersonnaliteArrayOrdrePlus[3][0] )
                .attr('opacity', "0") 
            ...
            etoile_jaune.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[0][1].length*10)
                .attr('x', milieuX+32 -200 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)
                .attr('y', milieuY-105 -SignPersonnaliteArrayOrdrePlus[0][1].length*5)   

            let SpecieTexteJaune = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteJaune")
                .attr('x', milieuX+ 32 -200 + 90)
            ...
            etoile_bleu.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[1][1].length*10)
                .attr('x', milieuX+106 -200 -SignPersonnaliteArrayOrdrePlus[1][1].length*5 )
                .attr('y', milieuY+60 -SignPersonnaliteArrayOrdrePlus[1][1].length*5) 
                
            let SpecieTexteBleu = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteBleu")
                .attr('x', milieuX+106 -200 +50)
                .attr('y', milieuY+60 -10 )    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[1][1].length + " " + SignPersonnaliteArrayOrdrePlus[1][0] )
                .attr('opacity', "0") 
            ...
            etoile_rose.transition()
                ...
                .attr('height', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('width', 50 + SignPersonnaliteArrayOrdrePlus[2][1].length*10)
                .attr('x', milieuX-152 -200 -SignPersonnaliteArrayOrdrePlus[2][1].length*5 )
                .attr('y', milieuY-245-SignPersonnaliteArrayOrdrePlus[2][1].length*5) 

            let SpecieTexteRose = MonEspaceSVG.append('text')
                .attr('id', "SpecieTexteRose")
                .attr('x', milieuX-152 -200-60)
                .attr('y', milieuY-245 -10)    
                .attr('fill', "white")
                .attr('font-family', "AnimalCrossing")
                .text(SignPersonnaliteArrayOrdrePlus[2][1].length + " " + SignPersonnaliteArrayOrdrePlus[2][0] )
                .attr('opacity', "0") 
